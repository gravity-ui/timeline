...
export class TimelineCanvasApi {
  ...
  constructor(options: {
    ...
    const canvas = options.timeline.renderRoot.querySelector("canvas");
    if (!canvas) {
  ...
  public clear(): void {
    this.ctx.fillStyle = yaTimelineConfig.resolveCssValue(
  ...
  public getComponent<T extends TimelineComponent>(
