...
export const TimePeriods: Story = {
  args: {
    "settings.start": timePeriodsConfig.settings.start,
    "settings.end": timePeriodsConfig.settings.end,
    "settings.axes": timePeriodsConfig.settings.axes,
    "settings.events": timePeriodsConfig.settings.events,
    "settings.markers": timePeriodsConfig.settings.markers || [],
    "settings.sections": timePeriodsConfig.settings.sections || [],
    "settings.selectedEventIds":
      timePeriodsConfig.settings.selectedEventIds || [],
    "viewConfiguration.hideRuler": false,
    "viewConfiguration.camera": {
      zoom: ZoomMode.DEFAULT,
    },
  ...
  parameters: {
    docs: {
      description: {
        story: `
Time periods example showing different parts of a day with coordinated colors.
Combines sections, events, and markers to create a comprehensive timeline view.

**Features Demonstrated:**
- Time period organization (morning, midday, afternoon)
- Coordinated color scheme across components
- Integration with events and markers
- Temporal context for daily workflows
- Mixed content types working together
        `,
      },
    },
  },
...
export const PriorityBased: Story = {
  args: {
    "settings.start": prioritySectionsConfig.settings.start,
    "settings.end": prioritySectionsConfig.settings.end,
    "settings.axes": prioritySectionsConfig.settings.axes,
    "settings.events": prioritySectionsConfig.settings.events,
    "settings.markers": prioritySectionsConfig.settings.markers || [],
    "settings.sections": prioritySectionsConfig.settings.sections || [],
    "settings.selectedEventIds":
      prioritySectionsConfig.settings.selectedEventIds || [],
    "viewConfiguration.hideRuler": false,
    "viewConfiguration.camera": {
      zoom: ZoomMode.DEFAULT,
    },
  ...
  parameters: {
    docs: {
      description: {
        story: `
Priority-based sections using color intensity to indicate urgency levels.
Perfect for project management and task prioritization visualizations.

**Features Demonstrated:**
- Color-coded priority levels (green → orange → red → purple)
- Increasing opacity for higher priority
- Visual hierarchy through color progression
...
export const SectionsOnly: Story = {
  args: {
    ...
    "settings.end": basicSectionsConfig.settings.end,
    "settings.axes": basicSectionsConfig.settings.axes,
    "settings.events": [], // No events
    "settings.markers": [], // No markers
    "settings.sections": basicSectionsConfig.settings.sections || [],
    "settings.selectedEventIds": [],
    "viewConfiguration.hideRuler": false,
    "viewConfiguration.camera": {
  ...
  parameters: {
    docs: {
      description: {
        story: `
Sections-only example showing pure background organization without events or markers.
Useful for creating templates or showing time allocation.

**Features Demonstrated:**
- Clean section visualization
- Focus on time period organization
- Template creation capabilities
- Background context without content
